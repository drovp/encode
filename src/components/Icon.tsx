...
const ICONS = {
	'add-brackets': (
		<svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
			<path d="M12 8C11.4477 8 11 8.44771 11 9V11H9C8.44771 11 8 11.4477 8 12C8 12.5523 8.44771 13 9 13H11V15C11 15.5523 11.4477 16 12 16C12.5523 16 13 15.5523 13 15V13H15C15.5523 13 16 12.5523 16 12C16 11.4477 15.5523 11 15 11H13V9C13 8.44771 12.5523 8 12 8Z" />
			<path d="M2 6C2 4.89543 2.89543 4 4 4H9C9.55228 4 10 4.44772 10 5C10 5.55228 9.55228 6 9 6H4V18H9C9.55228 18 10 18.4477 10 19C10 19.5523 9.55228 20 9 20H4C2.89543 20 2 19.1046 2 18V6Z" />
			<path d="M22 6C22 4.89543 21.1046 4 20 4H15C14.4477 4 14 4.44772 14 5C14 5.55228 14.4477 6 15 6H20V18H15C14.4477 18 14 18.4477 14 19C14 19.5523 14.4477 20 15 20H20C21.1046 20 22 19.1046 22 18V6Z" />
		</svg>
	),
	'arrow-horizontal': (
	...
	split: (
		<svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
			<path d="M11 3C11 2.44772 11.4477 2 12 2V2C12.5523 2 13 2.44772 13 3V21C13 21.5523 12.5523 22 12 22V22C11.4477 22 11 21.5523 11 21V3Z" />
			<path d="M14 6C14 4.89543 14.8954 4 16 4H21C21.5523 4 22 4.44772 22 5C22 5.55228 21.5523 6 21 6H16V18H21C21.5523 18 22 18.4477 22 19C22 19.5523 21.5523 20 21 20H16C14.8954 20 14 19.1046 14 18V6Z" />
			<path d="M10 6C10 4.89543 9.10457 4 8 4H3C2.44772 4 2 4.44772 2 5C2 5.55228 2.44772 6 3 6H8V18H3C2.44772 18 2 18.4477 2 19C2 19.5523 2.44772 20 3 20H8C9.10457 20 10 19.1046 10 18V6Z" />
		</svg>
	),
	'square-corners': (
		<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px">
